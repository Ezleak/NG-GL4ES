...
LOCAL_LDLIBS := -ldl -llog -lstdc++ -lGLESv2 -lGLESv3 -lEGL
...
LOCAL_CPP_SRC_FILES := \
    src/gl/translator.cpp

LOCAL_SRC_FILES := $(LOCAL_C_SRC_FILES) $(LOCAL_CPP_SRC_FILES)

LOCAL_CFLAGS += -g -std=c89 -funwind-tables -O3 -fvisibility=hidden -include include/android_debug.h
LOCAL_CFLAGS += -DNOX11
LOCAL_CFLAGS += -DNO_GBM
